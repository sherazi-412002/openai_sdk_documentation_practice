...
faq_agent = Agent(name="FAQ agent",tools=[get_weather,sum_numbers],model=external_model)
...
agent = Agent(
    ...
    Your task is to answer the user query using tools if you don't have specific tools then handoff to faq_agent and use its tools.
    """,
