...
result = Runner.run_sync(triage_agent,"What is digestion.")
print(result.last_agent.name)
print(result.final_output)



# Q: Why we use description override property in handoff fuction, it is useful in handoffing the agent. 
# Q: why our agent in handoff take instructions of agent instead of tool_description_override as a system prompt.
# Q: What happens when we introduce multiple tools with same name in agent.